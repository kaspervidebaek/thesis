...
Depending on what kind of choice of syntax tree is done, information of the concrete syntax might be lost. On the syntax tree level it might for example be easier to convert \texttt{int? x;} into the same structure as \texttt{Nullable<int> x;} to not clutter the abstract syntax tree with unnecessary information of syntactic sugar.
