...
To do a proper matching between trees, we will need to define equality and similarity. Between nodes.
...
Similarity is a little harder to define. Is the code $x=(1+2+3)$ similar to $f(1+2+3)$? One is a variable assignment and the other is a function call, which has quite different purposes in most programming languages. Also, they have atleast 5 nodes in common out of 7. The purpose of the similarity function is to do matchings, that will later allow us to merge items later on.

\todo[inline]{Skriv videre her}
